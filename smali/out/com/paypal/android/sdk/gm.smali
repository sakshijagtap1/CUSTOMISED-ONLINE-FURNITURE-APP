...
.method private static a(Landroid/content/Context;Landroid/widget/RelativeLayout;Ljava/lang/String;I)I
    ...
    invoke-static {v3, v3, v1, v2}, Lcom/paypal/android/sdk/cz;->a(IIII)Landroid/widget/RelativeLayout$LayoutParams;
    ...
    invoke-static {v0, v2, v4, v3, v4}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {v3, v4, v5, v6, v7}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p3}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-virtual {v0}, Lcom/paypal/android/sdk/gl;->a()Ljava/lang/String;
    ...
    invoke-static {v1, v5, v6, v7}, Lcom/paypal/android/sdk/cz;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Landroid/widget/RelativeLayout$LayoutParams;
    ...
    invoke-static {v4, v5, v6, v7, v8}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/paypal/android/sdk/gl;->f()Ljava/lang/String;
    ...
    invoke-static {v4, v5}, Lcom/paypal/android/sdk/cz;->b(Landroid/widget/TextView;I)V
    ...
    invoke-static {v4, v5, v6, v7, v8}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6, v7, v8}, Lcom/paypal/android/sdk/cz;->a(IIII)Landroid/widget/RelativeLayout$LayoutParams;

    move-result-object v5

    invoke-virtual {v3, v4, v5}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v0}, Lcom/paypal/android/sdk/gl;->g()Ljava/lang/String;

    move-result-object v4

    const/16 v5, 0x8ff

    invoke-static {v1, v3, v4, v5}, Lcom/paypal/android/sdk/gm;->a(Landroid/content/Context;Landroid/widget/RelativeLayout;Ljava/lang/String;I)I

    move-result v4

    invoke-virtual {v0}, Lcom/paypal/android/sdk/gl;->h()Ljava/lang/String;

    move-result-object v5

    invoke-static {v1, v3, v5, v4}, Lcom/paypal/android/sdk/gm;->a(Landroid/content/Context;Landroid/widget/RelativeLayout;Ljava/lang/String;I)I
    ...
    invoke-virtual {v0}, Lcom/paypal/android/sdk/gl;->i()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/paypal/android/sdk/gl;->j()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0}, Lcom/paypal/android/sdk/gl;->k()Ljava/lang/String;
    ...
    :cond_f4
    invoke-virtual {v0}, Lcom/paypal/android/sdk/gl;->l()Ljava/lang/String;
    ...
    invoke-static {v1, v3, v0, v4}, Lcom/paypal/android/sdk/gm;->a(Landroid/content/Context;Landroid/widget/RelativeLayout;Ljava/lang/String;I)I
