...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/gi;->d:Landroid/widget/TableLayout;

    invoke-virtual {v1, v0}, Landroid/widget/TableLayout;->addView(Landroid/view/View;)V

    iget-object v1, p0, Lcom/paypal/android/sdk/gi;->a:Landroid/widget/LinearLayout;

    iget-object v2, p0, Lcom/paypal/android/sdk/gi;->d:Landroid/widget/TableLayout;
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/gi;->b:Landroid/widget/RelativeLayout;
    ...
    invoke-static {v1, v2, v8}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/gi;->g:Landroid/widget/TextView;

    iget-object v1, p0, Lcom/paypal/android/sdk/gi;->g:Landroid/widget/TextView;

    invoke-static {v1, v5}, Lcom/paypal/android/sdk/cz;->d(Landroid/widget/TextView;I)V
    ...
    iget-object v2, p0, Lcom/paypal/android/sdk/gi;->g:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Lcom/paypal/android/sdk/gi;->f:Landroid/widget/TextView;

    iget-object v1, p0, Lcom/paypal/android/sdk/gi;->f:Landroid/widget/TextView;

    invoke-static {v1, v5}, Lcom/paypal/android/sdk/cz;->b(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v2, v3, v7}, Lcom/paypal/android/sdk/cz;->a(IIII)Landroid/widget/RelativeLayout$LayoutParams;

    move-result-object v1

    iget-object v2, p0, Lcom/paypal/android/sdk/gi;->b:Landroid/widget/RelativeLayout;
    ...
    invoke-static {p1, v1, v2}, Lcom/paypal/android/sdk/cz;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/ImageView;

    move-result-object v1

    iput-object v1, p0, Lcom/paypal/android/sdk/gi;->e:Landroid/widget/ImageView;

    iget-object v1, p0, Lcom/paypal/android/sdk/gi;->e:Landroid/widget/ImageView;
    ...
    invoke-static {p1, v1, v2, v3}, Lcom/paypal/android/sdk/cz;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)Landroid/widget/RelativeLayout$LayoutParams;
    ...
    iget-object v1, p0, Lcom/paypal/android/sdk/gi;->c:Landroid/widget/Button;
    ...
    iget-object v0, p0, Lcom/paypal/android/sdk/gi;->c:Landroid/widget/Button;

    const-string v1, "6dip"

    invoke-static {v0, v4, v4, v1, v4}, Lcom/paypal/android/sdk/cz;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/paypal/android/sdk/gi;->c:Landroid/widget/Button;

    const/16 v1, 0x15

    invoke-static {v0, v1, v8}, Lcom/paypal/android/sdk/cz;->a(Landroid/view/View;IF)V
